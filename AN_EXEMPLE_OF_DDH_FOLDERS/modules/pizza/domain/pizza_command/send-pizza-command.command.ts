...
type SendPizzaCommandPayload = { pizzaCommand : PizzaCommandAggregate, pizzasToSend:PizzaEntity[] };

export type SendPizzaCommandResult = Result<void , DeliveryGuyLost | ClientAddressNotUnderstood>;
