class Result<T, U> {
    ...
    private constructor( isSuccess:boolean, value?: T | null, error?: U | null ){
        if ( isSuccess && error ){
            throw new Error(
                "Invalid behavior : An error can't be considered as a success" );
        }
        if ( !isSuccess && value ){
            throw new Error(
                "Invalid behavior : A result can't be considered as an error" );
        }
    ...
    public getValue():T {
        if ( !this.isSuccess ){
            throw new Error(
                "Invalid behavior : Impossible to get value from error " );
        } else {
    ...
    public getError():U {
        if ( this.isSuccess ){
            throw new Error(
                "Invalid behavior : Impossible to get error from value " );
        } else {
